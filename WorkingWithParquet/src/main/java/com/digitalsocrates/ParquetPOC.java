package com.digitalsocrates;

import com.digitalsocrates.parquet.CustomParquetWriter;
...
public class ParquetPOC implements CommandLineRunner {
    ...
    private static final Logger logger = LoggerFactory.getLogger(ParquetPOC.class);

    public static void main(String[] args) {
        SpringApplication.run(ParquetPOC.class, args);
    }
